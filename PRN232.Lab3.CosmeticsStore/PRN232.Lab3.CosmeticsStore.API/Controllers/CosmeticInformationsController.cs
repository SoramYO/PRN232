...
namespace PRN232.Lab3.CosmeticsStore.API.Controllers
{
	...
	public class CosmeticInformationsController : ODataController
	{
		...
		public async Task<ActionResult<CosmeticInformation>> AddCosmeticInformation([FromBody] CosmeticInformationRequest cosmeticInformation)
		{
			try
			{
		...
		public async Task<ActionResult<CosmeticInformation>> UpdateCosmeticInformation(string id, [FromBody] CosmeticInformationRequest cosmeticInformation)
		{
			try
			{
		...
		public async Task<ActionResult<CosmeticInformation>> AddCosmeticInformation(string id)
		{
			try
			{
				var result = await _cismeticInformationService.GetById(id);
				return Ok(result);
			}
			catch (Exception ex)
			{
